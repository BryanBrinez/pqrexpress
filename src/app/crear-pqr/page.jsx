...
import citiesData from "@/libs/depAndCities.json";
...
export default function Page() {
  ...
  const fetchCities = async () => {
    try {
      // Ajusta la ruta según la ubicación real del archivo JSON
      setCities(citiesData);
      console.log(cities); // Asigna los datos al estado de ciudades
    } catch (error) {
  ...
  useEffect(() => {
    fetchCities(); // Llama a la función para cargar y asignar datos al estado
  }, []);
  return (
